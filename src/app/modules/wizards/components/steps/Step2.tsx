...
const Step2: FC = () => {
  ...
  const form200 = [
    ...
    const renderInput = (inputType:any, description:any) => {
      switch (inputType) {
        case 'text':
          return <input type="text" placeholder={description} className="form-control" />;
        case 'choice':
          return (
            <Select  
        ...
        case 'file':
          return <input type="file" placeholder={description} className="form-control" />;
        default:
          return null;
      }
    };
